		...
		<div class="reg_c">
            ...
            <table border="0" style="width:420px; font-size:14px; margin-top:20px;position: relative;" cellspacing="0" cellpadding="0">
              <tr height="50" valign="top">
              	<td width="95">&nbsp;</td>
                <td>
                	<span class="fl" style="font-size:24px;">注册</span><span class="fl" style="font-size:18px;"><a href="ShopRegist.jsp" style="margin-left:15px;color:#ff4e00;font-size: 18px;">商家入驻</a></span>
              ...
              <tr height="50">
                ...
                <td>
                	...
                	<input type="hidden" name="userType" value="0" class="l_user" />
                </td>
              </tr>
              <tr height="50">
