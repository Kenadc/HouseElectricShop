	...
	<div class="m_content">
		...
		<div class="m_right">
            ...
            <table border="0" class="order_tab" style="width:930px; text-align:center; margin-bottom:30px;" cellspacing="0" cellpadding="0">
              ...
              <c:if test="${orderfindByUserIdLists == null }">
					<script>
						window.location.href = '${pageContext.request.contextPath}/orderfindByUserId.action';
					</script>
				</c:if>
				<c:forEach var="order" items="${orderfindByUserIdLists }">
					<tr>
		                <td>
		                	<a href="/HouseElectricShop/productFindById.action?id=${order.orderDetail.product_id }">
			                	<font color="#ff4e00">
			                		${order.order_id }
			                	</font>
		                	</a>
