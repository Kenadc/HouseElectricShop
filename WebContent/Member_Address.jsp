		...
		<div class="m_right">
            ...
            <table border="0" class="add_tab" style="width:930px;"  cellspacing="0" cellpadding="0">
              ...
              <tr>
                ...
                <td style="font-family:'宋体';"><input type="text" id="nickName" value="${loginInfo.nickName }" class="add_ipt" />（必填）</td>
                <td align="right">电子邮箱</td>
                <td style="font-family:'宋体';"><input type="text" id="email" value="${loginInfo.email }" class="add_ipt" />（必填）</td>
              </tr>
              <tr>
                <td align="right">详细地址</td>
                <td style="font-family:'宋体';"><input type="text" id="liveAddress" value="${loginInfo.liveAddress }" class="add_ipt" />（必填）</td>
                <td align="right">手机</td>
                <td style="font-family:'宋体';"><input type="text" id="tel" value="${loginInfo.tel }" class="add_ipt" />（必填）</td>
              ...
              <!-- <tr>
           	...
           	<p align="right">
            	<a href="#">删除</a>&nbsp; &nbsp; <a class="add_b" onclick="sureEdit()">确认修改</a>
            </p> 
...
function sureEdit(){
	...
	if($("#liveAddress").val() == null || $("#liveAddress").val().trim() == ''){
		alert("详细地址不能为空!");
		return false;
	}
	...
	$.ajax({
		url : "/HouseElectricShop/userupdateaddress.action",
		type : "post",
		data:{
