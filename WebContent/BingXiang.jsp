...
<div id="kongtiao">
	...
	.postion p a {
		...
		<div class="postion" style="margin: auto; margin-top: 0px;">
			<p>
				<span>商品类型</span> 
				<a href="#" style="margin-left: 50px;" v-on:click="getkongtiaoInfo('对开门','1')">对开门</a>
				<a href="#" v-on:click="getkongtiaoInfo('多门','1')" style="margin-left: 30px;">多门</a> 
				<a href="#" v-on:click="getkongtiaoInfo('十字对开门','1')" style="margin-left: 30px;">十字对开门</a> 
				<a href="#" v-on:click="getkongtiaoInfo('三门','1')" style="margin-left: 30px;">三门</a>
				<a href="#" v-on:click="getkongtiaoInfo('电脑温控','1')" style="margin-left: 30px;">电脑温控</a>
				<a href="#" v-on:click="getkongtiaoInfo('1级能效','1')" style="margin-left: 30px;">1级能效</a>
				<a href="#" v-on:click="getkongtiaoInfo('双门','1')" style="margin-left: 30px;">双门</a>
				<a href="#" v-on:click="getkongtiaoInfo('风冷无霜','1')" style="margin-left: 30px;">风冷无霜</a>
			</p>
		</div>
		<div class="postion" style="margin: auto; margin-top: 0px;">
			<p>
				<span>冷柜</span>
				<a href="#" style="margin-left: 50px;" v-on:click="getkongtiaoInfo('卧式冷柜'),'1'">卧式冷柜</a>
				<a href="#" style="margin-left: 30px;" v-on:click="getkongtiaoInfo('家用冷柜','1')">家用冷柜</a>
				<a href="#" style="margin-left: 30px;" v-on:click="getkongtiaoInfo('商用展示柜','1')">商用展示柜</a>
				<a href="#" style="margin-left: 30px;" v-on:click="getkongtiaoInfo('冰吧立式冷柜','1')">冰吧立式冷柜</a>
				<a href="#" style="margin-left: 30px;" v-on:click="getkongtiaoInfo('酒柜','1')">酒柜</a>
				<a href="#" style="margin-left: 30px;" v-on:click="getkongtiaoInfo('厨房操作台','1')">厨房操作台</a>
				<a href="#" style="margin-left: 30px;" v-on:click="getkongtiaoInfo('星星大冷柜','1')">星星大冷柜</a>
			</p>
		</div>
		<!-- <div class="postion" style="margin: auto; margin-top: 0px;">
			<p>
