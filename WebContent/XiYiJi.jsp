...
<div id="kongtiao">
	...
	.postion p a {
		...
		<div class="postion" style="margin: auto; margin-top: 0px;">
			<p>
				<span>商品类型</span> 
				<a href="#" style="margin-left: 50px;" v-on:click="getkongtiaoInfo('滚筒','1')">滚筒</a>
				<a href="#" v-on:click="getkongtiaoInfo('洗干一体机','1')" style="margin-left: 30px;">洗干一体机</a> 
				<a href="#" v-on:click="getkongtiaoInfo('变频节能','1')" style="margin-left: 30px;">变频节能</a> 
				<a href="#" v-on:click="getkongtiaoInfo('波轮大容量','1')" style="margin-left: 30px;">波轮大容量</a>
		...
		<div class="postion" style="margin: auto; margin-top: 0px;">
			<p>
				<span>大牌热卖</span>
				<a href="#" style="margin-left: 50px;" v-on:click="getkongtiaoInfo('海尔'),'1'">海尔</a>
				<a href="#" style="margin-left: 30px;" v-on:click="getkongtiaoInfo('西门子','1')">西门子</a>
				<a href="#" style="margin-left: 30px;" v-on:click="getkongtiaoInfo('美的','1')">美的</a>
				<a href="#" style="margin-left: 30px;" v-on:click="getkongtiaoInfo('松下','1')">松下</a>
				<a href="#" style="margin-left: 30px;" v-on:click="getkongtiaoInfo('LG','1')">LG</a>
				<a href="#" style="margin-left: 30px;" v-on:click="getkongtiaoInfo('三星','1')">三星</a>
				<a href="#" style="margin-left: 30px;" v-on:click="getkongtiaoInfo('松桥','1')">松桥</a>
				<a href="#" style="margin-left: 30px;" v-on:click="getkongtiaoInfo('美菱','1')">美菱</a>
				<a href="#" style="margin-left: 30px;" v-on:click="getkongtiaoInfo('小天鹅','1')">小天鹅</a>
				<a href="#" style="margin-left: 30px;" v-on:click="getkongtiaoInfo('容声','1')">容声</a>
			</p>
		</div>
		<!-- <div class="postion" style="margin: auto; margin-top: 0px;">
			<p>
