            ...
            <div class="m_des">
                ...
                <table border="0" style="width:880px;"  cellspacing="0" cellpadding="0">
                  <tr height="45">
                    ...
                    <td style="width: 230px;"><input type="text" value="" id="tel" class="add_ipt" style="width:180px;" />&nbsp; <font color="#ff4e00">*</font></td>
                    <td><font color="#ff4e00" id="errorMsg"></font></td>
                  </tr>
                  <tr height="45">
                    <td align="right">新手机 &nbsp; &nbsp;</td>
                    <td><input type="text" value="" id="newTel" class="add_ipt" style="width:180px;" />&nbsp; <font color="#ff4e00">*</font></td>
                  </tr>
                  <tr height="50">
                    <td>&nbsp;</td>
                    <td><input type="button" onclick="editTel()" value="确认修改" class="btn_tj" /></td>
                  </tr>
                </table>
                </form>
            </div>
            ...
            <div class="m_des">
                ...
                <table border="0" style="width:880px;"  cellspacing="0" cellpadding="0">
                  <tr height="45">
                    ...
                    <td style="width: 230px;"><input type="text" value="" id="email" class="add_ipt" style="width:180px;" />&nbsp; <font color="#ff4e00">*</font></td>
                    <td><font color="#ff4e00" id="emailErrorMsg"></font></td>
                  </tr>
                  <tr height="45">
                    <td align="right">新邮箱 &nbsp; &nbsp;</td>
                    <td><input type="text" value="" id="newEmail" class="add_ipt" style="width:180px;" />&nbsp; <font color="#ff4e00">*</font></td>
                  </tr>
                  <tr height="50">
                    <td>&nbsp;</td>
                    <td><input type="button" onclick="editEmail()" value="确认修改" class="btn_tj" /></td>
                  </tr>
                </table>
                </form>
            </div>
            ...
            <div class="m_des">
                ...
                <table border="0" style="width:880px;"  cellspacing="0" cellpadding="0">
                  <tr height="45">
                    ...
                    <td style="width: 230px;"><input type="password" id="password" value="" class="add_ipt" style="width:180px;" />&nbsp; <font color="#ff4e00">*</font></td>
                    <td><font color="#ff4e00" id="passwordErrorMsg"></font></td>
                  </tr>
                  <tr height="45">
                    <td align="right">新密码 &nbsp; &nbsp;</td>
                    <td><input type="password" value="" id="newPassword" class="add_ipt" style="width:180px;" />&nbsp; <font color="#ff4e00">*</font></td>
                  </tr>
                  <tr height="45">
                    <td align="right">确认密码 &nbsp; &nbsp;</td>
                    <td><input type="password" value="" id="aginNewPassword" class="add_ipt" style="width:180px;" />&nbsp; <font color="#ff4e00">*</font></td>
                  </tr>
                  <tr height="50">
                    <td>&nbsp;</td>
                    <td><input type="button" onclick="editPassword()" value="确认修改" class="btn_tj" /></td>
                  </tr>
                </table>
                </form>
            </div>
...
function editTel(){
	...
	if($("#newTel").val() == null || $("#newTel").val().trim() == ''){
		alert("新手机号码不能为空!");
		return false;
	}
	$.ajax({
		url : "/HouseElectricShop/userupdatetelandsoon.action",
		type : "post",
		data:{
			"tel":$("#tel").val(),
			"newTel":$("#newTel").val(),
...
function editEmail(){
	...
	if($("#newEmail").val() == null || $("#newEmail").val().trim() == ''){
		alert("新邮箱不能为空!");
		return false;
	}
	$.ajax({
		...
		async: true,
		success : function(result) {
			$("#emailErrorMsg").text(result.data);
			window.location.reload();
		}
	});
}
function editPassword(){
	...
	if($("#aginNewPassword").val() == null || $("#aginNewPassword").val().trim() == ''){
		alert("确认密码不能为空!");
		return false;
	}
	...
	$.ajax({
		...
		async: true,
		success : function(result) {
			$("#passwordErrorMsg").text(result.data);
			window.location.reload();
		}
	});
}
