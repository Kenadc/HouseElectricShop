...
<div id="kongtiao">
	...
	.postion p a {
		...
		<div class="postion" style="margin: auto; margin-top: 0px;">
			<p>
				<span>厨房大电</span> 
				<a href="#" style="margin-left: 50px;" v-on:click="getkongtiaoInfo('厨房大电','1')">厨房大电</a>
				<a href="#" v-on:click="getkongtiaoInfo('烟灶套餐','1')" style="margin-left: 30px;">烟灶套餐</a> 
				<a href="#" v-on:click="getkongtiaoInfo('油烟机','1')" style="margin-left: 30px;">油烟机</a> 
				<a href="#" v-on:click="getkongtiaoInfo('燃气灶','1')" style="margin-left: 30px;">燃气灶</a>
				<a href="#" v-on:click="getkongtiaoInfo('消毒柜','1')" style="margin-left: 30px;">消毒柜</a>
				<a href="#" v-on:click="getkongtiaoInfo('洗碗机','1')" style="margin-left: 30px;">洗碗机</a>
				<a href="#" v-on:click="getkongtiaoInfo('嵌入式厨电','1')" style="margin-left: 30px;">嵌入式厨电</a>
				<a href="#" v-on:click="getkongtiaoInfo('集成灶','1')" style="margin-left: 30px;">集成灶</a>
				<a href="#" v-on:click="getkongtiaoInfo('垃圾处理器','1')" style="margin-left: 30px;">垃圾处理器</a>
			</p>
		</div>
		<div class="postion" style="margin: auto; margin-top: 0px;">
			<p>
				<span>卫浴电器</span>
				<a href="#" style="margin-left: 30px;" v-on:click="getkongtiaoInfo('热水器','1')">热水器</a>
				<a href="#" style="margin-left: 30px;" v-on:click="getkongtiaoInfo('电热水器','1')">电热水器</a>
				<a href="#" style="margin-left: 30px;" v-on:click="getkongtiaoInfo('燃气热水器','1')">燃气热水器</a>
				<a href="#" style="margin-left: 30px;" v-on:click="getkongtiaoInfo('厨宝','1')">厨宝</a>
				<a href="#" style="margin-left: 30px;" v-on:click="getkongtiaoInfo('智能马桶盖','1')">智能马桶盖</a>
				<a href="#" style="margin-left: 30px;" v-on:click="getkongtiaoInfo('浴霸','1')">浴霸</a>
				<a href="#" style="margin-left: 30px;" v-on:click="getkongtiaoInfo('空气能热水器','1')">空气能热水器</a>
			</p>
		</div>
		<div class="postion" style="margin: auto; margin-top: 0px;">
			<p>
				<span>净水器</span> 
				<a href="#" style="margin-left: 50px;" v-on:click="getkongtiaoInfo('饮水机','1')">饮水机</a> 
				<a  style="margin-left: 30px;" href="#" v-on:click="getkongtiaoInfo('净水杯','1')">净水杯</a> 
				<a style="margin-left: 30px;" href="#" v-on:click="getkongtiaoInfo('软水机','1')">软水机</a> 
				<a style="margin-left: 30px;" href="#" v-on:click="getkongtiaoInfo('净水滤芯','1')">净水滤芯</a> 
				<a style="margin-left: 30px;" href="#" v-on:click="getkongtiaoInfo('A.O.史密斯','1')">A.O.史密斯</a>
				<a style="margin-left: 30px;" href="#" v-on:click="getkongtiaoInfo('沁园','1')">沁园</a>
				<a style="margin-left: 30px;" href="#" v-on:click="getkongtiaoInfo('美的','1')">美的</a>
				<a style="margin-left: 30px;" href="#" v-on:click="getkongtiaoInfo('安吉尔','1')">安吉尔</a>
			</p>
		</div>
